    ...
    function delay(ms) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof window !== "undefined") {
                ...
                return new Promise((exec) => exec(0));
            }
        });
    }
    exports.delay = delay;
...
define("settings", ["require", "exports"], function (require, exports) {
    ...
    class Settings {
        constructor() {
            ...
            this.maximumNumberOfFacets = 100000;
                                    ...
                                    if (neighbourFacet != null) {
                                        ...
                                        for (let ns = 0; ns < neighbourSegments.length; ns++) {
                                            ...
                                            if (neighbourSegment != null &&
                                                ...
                                                let matchesStraight = segStartPoint.distanceTo(nSegStartPoint) <=
                                                    MAX_DISTANCE &&
                                                ...
                                                if (matchesStraight) {
                                                    ...
                                                    if (debug) {
                                                        console.log("Match found for facet " +
                                                            f.id +
                                                            " to neighbour " +
                                                            neighbourFacet.id);
                                                    }
...
define("facetCreator", ["require", "exports", "common", "lib/fill", "structs/boundingbox", "structs/point", "structs/typedarrays", "facetmanagement"], function (require, exports, common_5, fill_1, boundingbox_1, point_4, typedarrays_4, facetmanagement_3) {
    ...
    class FacetCreator {
        ...
        static buildFacet(facetIndex, facetColorIndex, x, y, visited, imgColorIndices, facetResult) {
            ...
            (0, fill_1.fill)(x, y, facetResult.width, facetResult.height, (ptx, pty) => visited.get(ptx, pty) ||
                imgColorIndices.get(ptx, pty) !== facetColorIndex, (ptx, pty) => {
...
define("guiprocessmanager", ["require", "exports", "colorreductionmanagement", "common", "facetBorderSegmenter", "facetBorderTracer", "facetCreator", "facetLabelPlacer", "facetmanagement", "facetReducer", "gui", "structs/point"], function (require, exports, colorreductionmanagement_2, common_7, facetBorderSegmenter_1, facetBorderTracer_1, facetCreator_3, facetLabelPlacer_1, facetmanagement_4, facetReducer_1, gui_1, point_5) {
    ...
    class GUIProcessManager {
        ...
        static process(settings, cancellationToken) {
            return __awaiter(this, void 0, void 0, function* () {
                const c = document.getElementById("input-image");
                ...
                // k-means clustering
                const kmeansImgData = yield GUIProcessManager.processKmeansClustering(imgData, ctx, settings, cancellationToken);
        ...
        static processKmeansClustering(imgData, ctx, settings, cancellationToken) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const cKmeans = document.getElementById("svgContainer");
        ...
        static processFacetReduction(facetResult, settings, colormapResult, cancellationToken) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const cReduction = document.getElementById("svgContainer");
        ...
        static processFacetBorderTracing(facetResult, cancellationToken) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const cBorderPath = document.getElementById("svgContainer");
        ...
        static processFacetBorderSegmentation(facetResult, settings, cancellationToken) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const cBorderSegment = document.getElementById("svgContainer");
        ...
        static processFacetLabelPlacement(facetResult, cBorderSegment, cancellationToken) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const cLabelPlacement = document.getElementById("svgContainer");
    ...
    GUIProcessManager.displayItem = "result-image";
});
/**
...
define("gui", ["require", "exports", "common", "guiprocessmanager", "settings"], function (require, exports, common_8, guiprocessmanager_1, settings_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.loadExample = exports.downloadSVG = exports.downloadPNG = exports.downloadPalettePng = exports.updateOutput = exports.process = exports.timeEnd = exports.time = void 0;
    ...
    function downloadSVG() {
        return __awaiter(this, void 0, void 0, function* () {
            const svgEl = $("#svgContainer").siblings("svg").get(0);
            if (!svgEl)
                return;
            $(".download-overlay").css("display", "block");
            yield (0, common_8.delay)(10000);
        ...
        init() {
            ...
            const observer = new MutationObserver(function (mutations) {
                mutations.forEach(function (mutation) {
                    if (_self.paste_event_support === true ||
...
define("main", ["require", "exports", "gui", "guiprocessmanager", "lib/clipboard", "settings"], function (require, exports, gui_2, guiprocessmanager_2, clipboard_1, settings_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const getDateDifference = (baseDate, currentDate) => {
    ...
    const validProcessCounts = () => {
        ...
        const limit = new settings_3.Settings().limitCounts;
        ...
        if (cacheCounts != null)
            countsProcess = Number(cacheCounts);
        if (cacheDates != null &&
    ...
    $(document).ready(function () {
        ...
        $(".tooltipped").tooltip();
        const clip = new clipboard_1.Clipboard("input-image", true);
            ...
            drop: function (e, ui) {
                ...
                if (dataTransfer && dataTransfer.files.length) {
                    ...
                    $.each(dataTransfer.files, function (i, file) {
                        ...
                        reader.onload = (event) => {
                            var _a;
                            const blobData = (_a = event.target) === null || _a === void 0 ? void 0 : _a.result;
                            const img = new Image();
                            img.src = blobData;
                            img.onload = () => {
        ...
        $("#btnProcess").click(function () {
            return __awaiter(this, void 0, void 0, function* () {
                if (guiprocessmanager_2.GUIProcessManager.isCanvasBlank(document.getElementById("input-image")))
                    return;
        ...
        $("#chkFillFacets").change(() => __awaiter(this, void 0, void 0, function* () {
